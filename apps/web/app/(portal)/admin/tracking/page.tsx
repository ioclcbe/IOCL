        ...
        <div className="panel p-0 overflow-hidden mt-6 mb-6">
          ...
          <div className="flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-slate-200">
            ...
            <div className="flex-1 p-6 flex flex-col">
              <p className="text-3xl font-black text-iocl-orange mb-6">{(Number(summaryData.quantities.ms || 0) + Number(summaryData.quantities.xpms || 0)).toFixed(1)} KL</p>
            ...
            {/* Right Column */}
            <div className="flex-1 p-6 flex flex-col">
              <p className="text-3xl font-black text-blue-600 mb-6">{(Number(summaryData.quantities.hsd || 0) + Number(summaryData.quantities.bioHsd || 0)).toFixed(1)} KL</p>
              <div className="flex flex-col gap-5 text-xl font-bold">
